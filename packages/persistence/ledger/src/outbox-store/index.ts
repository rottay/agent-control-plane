...
/**
 * The store's value types live in their own leaf, `./types/index.ts`, and are
 * re-exported here unchanged so every importer keeps reading them from this
 * module (CORR-2, ADR 0079).
 */
export type {
  OpenOutboxStoreOptions,
  OutboxCasOutcome,
