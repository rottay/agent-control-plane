import { type InitiativeTimelineResponse, type ScopedTimelineEntry } from "@acp/protocol";
 ...
 * constructor in `packages/domains/runtime` and `packages/entrypoints/cli`) — an all-null,
