...
| P-13 | Extracción de la composición del daemon | `DESIGN_READY` | [estructura §3](../../architecture/structure/index.md) | P-01 | rutas congeladas contra HEAD `a1f47ffc`: write-set P13, 18 rutas en dos escalones (canónico en `P13_WRITE_SET`; [ADR 0071](../../architecture/0071-the-daemon-composition-root-leaves-the-barrel.md)) |
