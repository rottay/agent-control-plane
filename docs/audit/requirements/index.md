...
| B15 | Registrar el resultado | runtime | resultado §10 · execution | M1/M2 | defecto | El resultado es recuperable por referencia y digest, y el terminal es correcto; un conteo de tokens no es un resultado |
